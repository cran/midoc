...
#'   \item{matage}{Mother's age at pregnancy, standardised relative to a mean age of 30}
#'   \item{mated}{Mother's educational level: post-16 years qualification or not}
